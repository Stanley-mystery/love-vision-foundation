  ...
  return (
    <section id="featured-departments" className="featured-departments section">
      ...
      >
        ...
        <p>
          Guided by our God-given mandate — to be a channel of blessing and
          restoration to individuals facing vision challenges. Through compassion,
          dedication, and the love of Christ, we are restoring sight, bringing hope,
          ...
          >
            <div className="department-card">
              ...
              <div className="department-content">
                ...
                <p>
                  Take a look at the incredible milestones achieved in August 2025 —
                  from restored vision to renewed hope, made possible through your
                  continued support and our shared mission to serve with love.
                </p>
                <a
                  href={ImpactReport2}
                  download
